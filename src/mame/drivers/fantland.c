...
-- */
	...
	PORT_BIT( 0xff, 0xbc, IPT_LIGHTGUN_Y ) PORT_CROSSHAIR(Y, 1.0, 0.0, 0) PORT_MINMAX(0x80,0xf9) PORT_SENSITIVITY(100) PORT_KEYDELTA(5) PORT_PLAYER(1)
	...
	PORT_BIT( 0xff, 0x5d, IPT_LIGHTGUN_X ) PORT_CROSSHAIR(X, 1.0, 0.0, 0) PORT_MINMAX(0x07,0xb4) PORT_SENSITIVITY(100) PORT_KEYDELTA(5) PORT_PLAYER(2)
