...
-- */
	...
	PORT_BIT( 0xff, 0xc0, IPT_LIGHTGUN_Y ) PORT_CROSSHAIR(Y, (352.0 - 12) / 352, 12.0 / 352, 0) PORT_MINMAX(0x80,0xff) PORT_SENSITIVITY(100) PORT_KEYDELTA(5) PORT_PLAYER(1)
	PORT_START("P1 Lightgun X")		/* 57001 */
	PORT_BIT( 0xff, 0x60, IPT_LIGHTGUN_X ) PORT_CROSSHAIR(X, 1.0, 0.0, 0) PORT_MINMAX(0x00,0xc0) PORT_SENSITIVITY(100) PORT_KEYDELTA(5) PORT_PLAYER(1)
