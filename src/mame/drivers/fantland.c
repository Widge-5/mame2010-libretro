...
-- */
	...
	PORT_BIT( 0xff, 0xba, IPT_LIGHTGUN_Y ) PORT_CROSSHAIR(Y, (352.0 - 12) / 352, 12.0 / 352, 0) PORT_MINMAX(0x80,0xf4) PORT_SENSITIVITY(100) PORT_KEYDELTA(5) PORT_PLAYER(1)
	PORT_START("P1 Lightgun X")		/* 57001 */
	PORT_BIT( 0xff, 0x5b, IPT_LIGHTGUN_X ) PORT_CROSSHAIR(X, 1.0, 0.0, 0) PORT_MINMAX(0x07,0xb0) PORT_SENSITIVITY(100) PORT_KEYDELTA(5) PORT_PLAYER(1)
	PORT_START("P2 Lightgun Y")		/* 57002 */
	PORT_BIT( 0xff, 0xba, IPT_LIGHTGUN_Y ) PORT_CROSSHAIR(Y, 1.0, 0.0, 0) PORT_MINMAX(0x80,0xf4) PORT_SENSITIVITY(100) PORT_KEYDELTA(5) PORT_PLAYER(2)
	PORT_START("P2 Lightgun X")		/* 57003 */
	PORT_BIT( 0xff, 0x5b, IPT_LIGHTGUN_X ) PORT_CROSSHAIR(X, 1.0, 0.0, 0) PORT_MINMAX(0x07,0xb0) PORT_SENSITIVITY(100) PORT_KEYDELTA(5) PORT_PLAYER(2)
