...
//  PORT_DIPSETTING(    0x01, "Lightgun" )
	...
	PORT_DIPSETTING(    0x00, DEF_STR( On ) )
/*
Y is more or less where I want it to be but the crosshair is slightly off
- just teting whether original minmax helps (on P1) or slight reduction of the crosshair offset (on P2) make a diffeence
...
//	PORT_BIT( 0xff, 0xb0, IPT_LIGHTGUN_Y ) PORT_CROSSHAIR(Y, (352.0 - 12) / 352, 12.0 / 352, 0) PORT_MINMAX(0x80,0xfc) PORT_SENSITIVITY(100) PORT_KEYDELTA(5) PORT_PLAYER(1)
	PORT_BIT( 0xff, 0xb6, IPT_LIGHTGUN_Y ) PORT_CROSSHAIR(Y, (352.0 - 12) / 352, 12.0 / 352, 0) PORT_MINMAX(0x80,0xfc) PORT_SENSITIVITY(100) PORT_KEYDELTA(5) PORT_PLAYER(1)
...
//	PORT_BIT( 0xff, 0x60, IPT_LIGHTGUN_X ) PORT_CROSSHAIR(X, 1.0, 0.0, 0) PORT_MINMAX(0x07,0xb7) PORT_SENSITIVITY(100) PORT_KEYDELTA(5) PORT_PLAYER(1)
	PORT_BIT( 0xff, 0x5e, IPT_LIGHTGUN_X ) PORT_CROSSHAIR(X, 1.0, 0.0, 0) PORT_MINMAX(0x07,0xb7) PORT_SENSITIVITY(100) PORT_KEYDELTA(5) PORT_PLAYER(1)
...
//	PORT_BIT( 0xff, 0xb0, IPT_LIGHTGUN_Y ) PORT_CROSSHAIR(Y, (352.0 - 12) / 352, 12.0 / 352, 0) PORT_MINMAX(0x80,0xfc) PORT_SENSITIVITY(100) PORT_KEYDELTA(5) PORT_PLAYER(2)
	PORT_BIT( 0xff, 0xb6, IPT_LIGHTGUN_Y ) PORT_CROSSHAIR(Y, (352.0 - 10) / 352, 12.0 / 352, 0) PORT_MINMAX(128,255) PORT_SENSITIVITY(100) PORT_KEYDELTA(5) PORT_PLAYER(2)
