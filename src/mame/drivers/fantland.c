...
-- */
	...
	PORT_BIT( 0xff, 0x5b, IPT_LIGHTGUN_X ) PORT_CROSSHAIR(X, 1.0, 5.0, 0) PORT_MINMAX(0x07,0xb0) PORT_SENSITIVITY(100) PORT_KEYDELTA(5) PORT_PLAYER(1)
	...
	PORT_BIT( 0xff, 0x5b, IPT_LIGHTGUN_X ) PORT_CROSSHAIR(X, 1.0, 10.0, 0) PORT_MINMAX(0x07,0xb0) PORT_SENSITIVITY(100) PORT_KEYDELTA(5) PORT_PLAYER(2)
