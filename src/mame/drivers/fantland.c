...
-- */
	...
	PORT_BIT( 0xff, 0x5b, IPT_LIGHTGUN_X ) PORT_CROSSHAIR(X, 1.0, 0.0, 0) PORT_MINMAX(0x07,0xaf) PORT_SENSITIVITY(100) PORT_KEYDELTA(5) PORT_PLAYER(1)
	PORT_START("P2 Lightgun Y")		/* 57002 */
	PORT_BIT( 0xff, 0xc0, IPT_LIGHTGUN_Y ) PORT_CROSSHAIR(Y, 1.0, 0.0, 0) PORT_MINMAX(0x80,0xff) PORT_SENSITIVITY(100) PORT_KEYDELTA(5) PORT_PLAYER(2)
