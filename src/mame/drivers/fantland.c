...
-- */
	...
	PORT_BIT( 0xff, 0xbe, IPT_LIGHTGUN_Y ) PORT_CROSSHAIR(Y, 1.0, 0.0, 0) PORT_MINMAX(0x80,0xfc) PORT_SENSITIVITY(100) PORT_KEYDELTA(5) PORT_PLAYER(1)
	PORT_START("P1 Lightgun X")		/* 57001 */
	PORT_BIT( 0xff, 0x5e, IPT_LIGHTGUN_X ) PORT_CROSSHAIR(X, 1.0, 0.0, 0) PORT_MINMAX(0x07,0xb3) PORT_SENSITIVITY(100) PORT_KEYDELTA(5) PORT_PLAYER(1)
	PORT_START("P2 Lightgun Y")		/* 57002 */
	PORT_BIT( 0xff, 0xb6, IPT_LIGHTGUN_Y ) PORT_CROSSHAIR(Y, 1.0, 0.0, 0) PORT_MINMAX(0x80,0xfc) PORT_SENSITIVITY(100) PORT_KEYDELTA(5) PORT_PLAYER(2)
	PORT_START("P2 Lightgun X")		/* 57003 */
	PORT_BIT( 0xff, 0x5d, IPT_LIGHTGUN_X ) PORT_CROSSHAIR(X, 1.0, 0.0, 0) PORT_MINMAX(0x07,0xb3) PORT_SENSITIVITY(100) PORT_KEYDELTA(5) PORT_PLAYER(2)
